# Whisper FastAPI 服務（faster-whisper 版本）
from fastapi import FastAPI, File, UploadFile, HTTPException
from faster_whisper import WhisperModel
import tempfile
import os

app = FastAPI(title="Whisper API", description="Whisper 語音識別 API (faster-whisper)")
